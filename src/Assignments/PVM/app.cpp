...
void SimpleShapeApplication::init() {
    ...
    glm::mat4 model(1.0f);
    glm::mat4 projection = glm::perspective(45.0f, 650.0f/480.0f, 1.0f, 5.0f);
    glm::mat4 view = glm::lookAt(glm::vec3(4.0f, 0.0f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
